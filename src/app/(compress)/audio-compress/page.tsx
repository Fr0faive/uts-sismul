  ...
  return (
    <section className="w-full p-6">
      <div className="w-full flex justify-center items-center flex-col gap-6">
        <h1 className="text-3xl font-semibold">Audio Compress</h1>
        <div className="w-full flex flex-col justify-center items-center border border-black p-3">
          <div className="w-full flex flex-col justify-center items-center mb-3">
            <FileInput onFileInput={onFileInput} />
            <i className="text-sm">Max Filesize: 2 GB</i>
          </div>

          <FormatSelector onCodecChange={onCodecChange} codec={codec} />

          <h5 className="mt-3 font-semibold text-lg">Encoder Settings</h5>
          {showEncoderSettings()}
          ...
          <input
            type="text"
            autoComplete="off"
            className="form-control border border-black w-full p-2 text-center rounded-2xl"
            maxLength={200}
            id="output_name"
            required
          />
          ...
          <div id="convert_btn" className="mt-2">
